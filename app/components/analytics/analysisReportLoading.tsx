...
export default function AnalysisReportLoading({ ticker }: AnalysisReportLoadingProps) {
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-4">
                        <div>
                            ...
                            <p className="mt-4 max-w-2xl text-sm leading-relaxed text-slate-300 md:text-base">
                                The report is being generated from filing data, financial signals, risk factors,
                                management commentary, and investor-facing decision points.
                            </p>
                        </div>
